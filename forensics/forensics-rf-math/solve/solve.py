...
class solve(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.rrc_0 = rrc_0 = firdes.root_raised_cosine(n_filts, n_filts,1/float(sps), 0.35, n_filts)
        ...
        self.filter_fft_low_pass_filter_0 = filter.fft_filter_ccc(2, firdes.low_pass(1, samp_rate, 5000, 1000, window.WIN_HAMMING, 6.76), 1)
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(sps/2, 6.25/100, rrc_0, n_filts, n_filts/2, 1.5, 1)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '../challenge/samples.bin', False, 0, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_file_source_0, 0), (self.filter_fft_low_pass_filter_0, 0))
        ...
        self.connect((self.filter_fft_low_pass_filter_0, 0), (self.digital_pfb_clock_sync_xxx_0, 0))
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.set_rrc_0(firdes.root_raised_cosine(self.n_filts, self.n_filts, 1/float(self.sps), 0.35, self.n_filts))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.filter_fft_low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 5000, 1000, window.WIN_HAMMING, 6.76))
    ...
    def set_rrc_0(self, rrc_0):
        self.rrc_0 = rrc_0
        self.digital_pfb_clock_sync_xxx_0.update_taps(self.rrc_0)
